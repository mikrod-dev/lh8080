...
<aside class="sidebar col-auto p-3 mt-5">
    <nav class="d-flex flex-column h-auto gap-2">
        <h5 class="text-center d-none d-md-block">Mi panel</h5>
        <hr class="border-secondary mt-0 d-none d-md-block">
        ...
        <a class="nav-link d-flex gap-3 align-items-center"
           href="/dashboard/user/profile">
            ...
            <span class="d-none d-md-inline">Preferencias</span>
        </a>
        ...
        <a class="nav-link d-flex gap-3 align-items-center"
           href="/dashboard/user/posts">
            ...
            <span class="d-none d-md-inline">Mis posts</span>
        </a>

        <a class="nav-link d-flex gap-3 align-items-center"
           href="/dashboard/user/readlists">
            <svg xmlns="http://www.w3.org/2000/svg"
                 width="16" height="16" fill="currentColor"
            ...
            <span class="d-none d-md-inline">Readlists</span>
        </a>
