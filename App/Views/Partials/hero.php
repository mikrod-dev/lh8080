...
<main class="px-4 py-5 flex-grow-1">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div class="col-12 col-lg-6">
            <img src="<?php echo IMAGES ?>hero-image.png"
        ...
        <div class="col-lg-6">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                <a class="btn btn-primary btn-lg px-4 me-md-2" href="/blog">Leer posts</a>
                <a class="btn btn-outline-secondary btn-lg px-4" href="/login">Iniciar sesión</a>
            </div>
